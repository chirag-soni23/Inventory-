...
import { Upload, Download, TrendingUp, Package, BarChart3 } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      {forecastData && (
        <div className="space-y-6">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 flex-1">
                <div>
                  ...
                  <p className="font-semibold">{formData.product_id}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-semibold">{formData.days} days</p>
                </div>
              </div>
            </div>
          </Card>
          ...
          {/* Forecast Table */}
          <Card title="Forecast Data" subtitle="Detailed forecast breakdown" icon={BarChart3}>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {forecastData.Forecast.map((item, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{item.demand}</td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                            item.demand > forecastData["Reorder Point"]
                              ? "bg-success-100 text-success-800"
                              : item.demand > forecastData["Minimum Level"]
